        ...
        <div className="logright">
          <div className="logo">
            ...
            <form action="">
                ...
                <button>Login</button>
                <p className='sign'>Don't have an account? <Link to="/signup">Signup</Link></p>
                <div className="con">
                <hr />
                <p className='or'>or</p>
                </div>
                <a href="#" className="gbtn"> 
                <svg className="gicon" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="23" height="23" viewBox="0 0 48 48">
